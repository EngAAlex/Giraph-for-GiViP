...
public interface CentralizedServiceWorker<I extends WritableComparable,
  ...
  //ADDED NEXT 2 METHODS
  
  /**
   * 
   * Get the worker's MessagesSniffer
   * 
   * @return MessagesSniffer instance (to create and save runtime messages in)
   * 
   */
  MessagesSniffer getMessagesSniffer();

  /**
   * 
   * Get ExecutedSuperstepWorkerInfo
   * 
   * @return ExecutedSuperstepWorkerInfo instance
   * 
   */
  ExecutedSuperstepWorkerInfo getSuperstepInfo();
