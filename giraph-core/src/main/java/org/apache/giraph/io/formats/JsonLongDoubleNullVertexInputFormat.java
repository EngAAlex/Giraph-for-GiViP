...
/**
  ...
  */
public class JsonLongDoubleNullVertexInputFormat extends
  TextVertexInputFormat<LongWritable, DoubleWritable, NullWritable> {

  @Override
  public TextVertexReader createVertexReader(InputSplit split,
      TaskAttemptContext context) {
    return new JsonLongDoubleNullVertexReader();
  }
  ...
  * [1,4.3,[[2,2.1],[3,0.7]]]
  */
  class JsonLongDoubleNullVertexReader extends
    ...
    @Override
    protected Vertex<LongWritable, DoubleWritable, NullWritable>
