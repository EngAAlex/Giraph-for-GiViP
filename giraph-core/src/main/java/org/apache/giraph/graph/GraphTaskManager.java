...
ResetSuperstepMetricsObserver {
  ...
  static { // Eliminate this? Even MRv1 tasks should not need it here.
	...
	private void postApplication() throws IOException, InterruptedException {
		...
		//ADDED CODE
		//    LOG.info("mariaDebuggingLogs: Copying of worker data during post application");
		String jobId = null;
		String localFilePath, folder;
		//      LOG.info("mariaDebuggingLogs: Worker postApplication operations");
